...
CREATE TABLE `grant_queries` (
  ...
  `userUuid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validationToken` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `activationTokenUuid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2023-05-14 19:46:58
